...
public class KeyReader {
    ...
    public String getAPIKey(){
        return property.getProperty("apiKey");} //läser raden i txt filen apikey
    public String getKey (String key){return property.getProperty(key);} // returnerar det som finns txt filen efter = tecknet "nyckeln"
